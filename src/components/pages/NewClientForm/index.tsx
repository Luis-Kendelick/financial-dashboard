  ...
  return (
    <FormProvider {...formMethods}>
      <form className="flex flex-col w-full h-full">
        {/* <div > */}
          <h1 className="text-black-87 tracking-wide font-inter font-medium text-xl mb-7">
            Adicionar cliente
          </h1>
          <div className="w-full h-full bg-white-two flex flex-col justify-between border-[1px] border-neutral-300 border-solid rounded-cards">
            {/* //HEADER */}
            ...
            {/* FOOTER */}
            <div className="h-20 w-full bg-ice-blue border-t-[1px] border-neutral-300 border-solid rounded-cards flex items-center">
              <button
                type="submit"
                form="client-form"
                className={
                  "bg-blue-violet hover:bg-blue-violet-2 px-5 rounded-cards flex items-center h-2/4 w-40 ml-5"
                }
              >
              ...
              <NavLink
                to={"/clients"}
                className={
                  "hover:bg-neutral-200 px-5 rounded-cards flex items-center h-2/4 w-40 ml-5"
                }
              >
